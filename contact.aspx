<%@ Page Title="" Language="C#" MasterPageFile="~/Client/clientMasterPage.master" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="Client_contact" %>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <form class="contact-form me-lg-5 pe-lg-3" role="form">
                                ...
                                <div class="form-floating mb-4">
                                    ...
                                    <label for="message">Tell us about the product</label>
                                </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 ms-auto">
                            <div class="row">
                                ...
                                <div class="col-6 border-top border-end contact-info">
                                    ...
                                    <p class="text-muted">mainbajaMain Bazar Rd, Babra, Gujarat 365421</p>
                                </div>
